...
public interface BoardRepository extends JpaRepository<BoardEntity, Long> {
	...
	@Modifying
//	@Query(value="UPDATE board b SET b.re_step=b.re_step+1 WHERE b.ref=1 AND b.re_step >3")  // 쿼리 이용
	@Query(value="UPDATE BoardEntity b SET b.reStep=b.reStep+1 WHERE b.ref=:ref AND b.reStep >:reStep")    //JPA 이용
	...
	BoardEntity findWithMemberByNum(@Param("num")long num);
